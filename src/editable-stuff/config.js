...
//      i.e: profilePictureLink: require("../editable-stuff/habeeb.jpg"),
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/habeeb.jpg"),
  imageSize: 250,
  message:
...
const repos = {
  ...
  gitHubUsername: "mhdh-9", //i.e."johnDoe12Gh"
  reposLength: 0,
  specificRepos: ["TodoList_WebApp-NodeJs-MongoDB-Heroku" ,"tindog" ,"Drum-kit_WebApp-JavaScript" ,"Simon_Game" ],
};
...
const leadership = {
  ...
  images: [
    {
      img: require("../editable-stuff/habeeb.jpg"),
